...
##Buttons
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports button]
...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports sclk]
create_clock -period 20.000 -name sys_clk -waveform {0.000 10.000} -add [get_ports sclk]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sclk_IBUF]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports cs]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports mosi]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports miso]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports sd_cmd]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports sd_clk]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports send_cmd]
#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports done]
